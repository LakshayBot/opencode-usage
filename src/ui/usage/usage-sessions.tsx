/**
 * "By session" view for the /usage popup.
 *
 * A native `DialogSelect` list cloned from the By agent / By project views,
 * so search, arrow navigation and Enter/Esc all come from the host. There is
 * no session detail drill-down (rows carry no onSelect). Like the graph
